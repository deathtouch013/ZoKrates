...
use crate::funciones::compute_witness::compute_witness as cw;
use crate::funciones::generate_proof::generate_proof as gp;
use crate::funciones::setup::setup as st;
use crate::funciones::verify::verify as vr;
...
pub fn compile_default(
    ...
    compilation::<Bn128Field>(input_file, output_file, rc1s_file, abi_file, stdlib_path)
}
...
pub fn setup_default(
    ...
    st(input_file, constants::ARK, constants::G16, proving_file, verification_file)
}

pub fn compute_witness_default(
    input_file: &str,
    witness_file: &str,
    out_wtns_file: &str,
    arguments: Vec<&str>
) -> Result<(), String> {
    cw(input_file, witness_file, out_wtns_file, arguments)
}

pub fn generate_proof_default(
    input_file: &str,
    witness_file: &str,
    prooving_file: &str,
    proof_file: &str
) -> Result<(), String> {
    gp(input_file, witness_file, prooving_file, proof_file, constants::ARK, constants::G16)
}
...
pub fn verify_default(
    ...
    vr(verification_file, proof_file, constants::ARK)
}

#[cfg(test)]
mod tests {
    use crate::{compile_default, compute_witness_default, generate_proof_default, setup_default, verify_default};
    #[test]
    fn llamada_modulo() {
